...
import InstallerAppointmentPage from './app/installer/appointments/InstallerAppointmentPage';
import ActivityLogPage from './app/installer/activity/ActivityLogPage';
import JobDetailPage from './app/installer/jobs/JobDetailPage';
import IFIDashboard from './app/installer/dashboard/IFIDashboard';
import MockJobsPage from './app/installer/jobs/MockJobsPage';
import FeedbackPage from './app/installer/FeedbackPage';
import InstallManagerDashboard from './app/install-manager/InstallManagerDashboard.jsx';
import AdminDashboard from './app/admin/AdminDashboard';
import SalesDashboard from './app/sales/SalesDashboard';
import NewJobBuilderPage from './app/install-manager/jobs/NewJobBuilderPage';
import AdminNewJob from './app/admin/jobs/AdminNewJob';
import AdminJobDetail from './app/admin/jobs/AdminJobDetailPage';
import InstallerDashboard from './app/installer/dashboard/InstallerDashboard';
...
import InventoryPage from './app/installer/inventory/InventoryPage';
import JobHistoryPage from './app/installer/jobs/JobHistoryPage';
import ClientsPage from './app/clients/ClientsPage';
import QuotesPage from './app/sales/QuotesPage';
import InvoicesPage from './app/admin/invoices/InvoicesPage';
import InvoiceDetailPage from './app/admin/invoices/InvoiceDetailPage';
import PaymentsPage from './app/admin/payments/PaymentsPage';
...
import MessagesPanel from './app/shared/messages/MessagesPanel';
import TimeTrackingPanel from './app/shared/time-tracking/TimeTrackingPanel';
import ReportsPage from './app/admin/reports/ReportsPage';
import TechnicianPayReportPage from './app/admin/reports/TechnicianPayReportPage';
import InvoiceAgingPage from './app/admin/reports/InvoiceAgingPage';
...
import ChecklistRouter from './app/installer/checklist/ChecklistRouter';
import ChecklistIndexPage from './app/installer/checklist/ChecklistIndexPage';
...
export const ROUTES: RouteConfig[] = [
  ...
  {
    path: '/installer/job/:jobId/checklist',
    element: <ChecklistIndexPage />,
    role: 'Installer',
    label: 'Checklist',
  },
  {
    path: '/installer/job/:jobId/checklist/:stepId',
    element: <ChecklistRouter />,
    role: 'Installer',
  },
