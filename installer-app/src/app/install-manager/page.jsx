...
export default function InstallManagerDashboard() {
  ...
  const handleEdit = (job: any) => setEditJob(job);
  const handleUpload = (id: string) => console.log("upload", id);
  const handleAssignInventory = (id: string) => console.log("assign inventory", id);

  return (
    <div className="p-4">
      <header className="sticky top-0 bg-white p-4 shadow mb-4 flex justify-between items-center">
